...
Однако, у вас могла возникнуть ошибка аутентификации, так как GitHub с 2021 года перестал поддерживать авторизацию по паролю для `git push` и других операций через терминал
